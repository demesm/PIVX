...
#   c) node1 mines 32 blocks, so now node 0 has 60001sku, node 1 has 4250sku, node2 has none.
#   d) node0 sends 601 sku to node2, in two transactions (301 sku, then 300 sku).
