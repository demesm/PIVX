...
RESOURCES += src/qt/skucoin.qrc src/qt/skucoin_locale.qrc

TRANSLATIONS += src/qt/locale/skucoin_bg.ts \
                src/qt/locale/skucoin_de.ts \
                src/qt/locale/skucoin_en.ts \
                src/qt/locale/skucoin_es.ts \
                src/qt/locale/skucoin_fi.ts \
                src/qt/locale/skucoin_fr.ts \
                src/qt/locale/skucoin_it.ts \
                src/qt/locale/skucoin_ja.ts \
                src/qt/locale/skucoin_pl.ts \
                src/qt/locale/skucoin_pt.ts \
                src/qt/locale/skucoin_ru.ts \
                src/qt/locale/skucoin_sk.ts \
                src/qt/locale/skucoin_sv.ts \
                src/qt/locale/skucoin_vi.ts \
                src/qt/locale/skucoin_zh_CN.ts \
                src/qt/locale/skucoin_zh_TW.ts
