Contributing to SKUCOIN Core
============================

The SKUCOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SKUCOIN Core project, and is not to be
confused with overall SKUCOIN Network Protocol consensus changes.

Whether a pull request is merged into SKUCOIN Core rests with the project merge
...
Patches that change SKUCOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the SKUCOIN consensus, it must have been
...
The project leader is the release manager for each SKUCOIN Core release.
