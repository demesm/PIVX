...
In order to support loading of multiple wallets in skucoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is skucoin.cpp.
...
Changes to skucoin.cpp
----------------------
skucoin.cpp is the entry point into skucoin-qt, and as such, will require some minor modifications to provide hooks for
