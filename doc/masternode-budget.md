...
SKUCOIN now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<skucoin_address\> \<monthly_payment_skucoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ SKUCOIN, _12_ times over the course of a year totaling _24000_ SKUCOIN.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<skucoin_address\> \<monthly_payment_skucoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` SKUCOIN.
