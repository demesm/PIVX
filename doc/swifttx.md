...
This mechanism has been integrated into Bitcore-Node-SKUCOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SKUCOIN-Project/insight-api-skucoin#web-socket-api](https://github.com/SKUCOIN-Project/insight-api-skucoin#web-socket-api) 
* API: [https://github.com/SKUCOIN-Project/insight-api-skucoin#swifttx-transactions](https://github.com/SKUCOIN-Project/insight-api-skucoin#swifttx-transactions) 
...
By default, the SKUCOIN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SKUCOIN Core daemon:
