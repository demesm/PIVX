...
/**
 * SKUCOIN RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzskuseed(const UniValue& params, bool fHelp);
extern UniValue getzskuseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzsku(const UniValue& params, bool fHelp);
extern UniValue dzskustate(const UniValue& params, bool fHelp);
