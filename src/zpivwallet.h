...
#ifndef SKUCOIN_ZSKUWALLET_H
#define SKUCOIN_ZSKUWALLET_H
...
public:
    CzSKUWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSKU(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSKU(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //SKUCOIN_ZSKUWALLET_H
