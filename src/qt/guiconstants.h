...
/* Skucoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SKUCOIN"
#define QAPP_ORG_DOMAIN "skucoin.org"
#define QAPP_APP_NAME_DEFAULT "SKUCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "SKUCOIN-Qt-testnet"
