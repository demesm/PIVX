                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SKUCOIN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SKUCOIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and skucoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSKU"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SKUCOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about SKUCOIN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SKUCOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SKUCOIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SKUCOIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a SKUCOIN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SKUCOIN Core help message to get a list with possible SKUCOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SKUCOIN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SKUCOIN network", "", count));
}
...
{
    QString strTitle = tr("SKUCOIN Core"); // default title
