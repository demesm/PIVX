                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSKUPathCustom = GetArg("-zskubackuppath", "");
    ...
    if(!strzSKUPathCustom.empty()) {
        ui->wallet_customzskubackuppath->setText(QString::fromStdString(strzSKUPathCustom));
        ui->wallet_customzskubackuppath_label->setVisible(true);
        ui->wallet_customzskubackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSKUPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SKUCOIN RPC console.") + "<br>" +
