...
/** Utility functions used by the SKUCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render SKUCOIN addresses in monospace font
...
// Parse "skucoin:" URI into recipient object, return true on successful parsing
