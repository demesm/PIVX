...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "SKUCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SKUCOIN features */
        {"skucoin", "masternode", &masternode, true, true, false},
        {"skucoin", "listmasternodes", &listmasternodes, true, true, false},
        {"skucoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"skucoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"skucoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"skucoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"skucoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"skucoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"skucoin", "masternodedebug", &masternodedebug, true, true, false},
        {"skucoin", "startmasternode", &startmasternode, true, true, false},
        {"skucoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"skucoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"skucoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"skucoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"skucoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"skucoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"skucoin", "mnbudget", &mnbudget, true, true, false},
        {"skucoin", "preparebudget", &preparebudget, true, true, false},
        {"skucoin", "submitbudget", &submitbudget, true, true, false},
        {"skucoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"skucoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"skucoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"skucoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"skucoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"skucoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"skucoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"skucoin", "checkbudgets", &checkbudgets, true, true, false},
        {"skucoin", "mnsync", &mnsync, true, true, false},
        {"skucoin", "spork", &spork, true, true, false},
        {"skucoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzskuseed", &getzskuseed, false, false, true},
        {"zerocoin", "setzskuseed", &setzskuseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzsku", &searchdzsku, false, false, true},
        {"zerocoin", "dzskustate", &dzskustate, false, false, true}
...
{
    return "> skucoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:30983/\n";
}
