...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Skucoin Core skucoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  skucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded skucoin transaction") + "\n" +
                               "  skucoin-tx [options] -create [commands]   " + _("Create hex-encoded skucoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded skucoin transaction
