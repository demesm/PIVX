...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "skucoin.seed2.fuzzbawls.pw"));    // Secondary DNS Seeder from Fuzzbawls
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "skucoin-testnet.seed2.fuzzbawls.pw"));
